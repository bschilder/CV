...
extra <- list("### Imperial College London",
              "### PhD Student",
              "### MPhil, ScB"
              )  
logo <- get_logo(
...
\
\
The total height of each column represents overall expertise in a given domain. 
Rectangles are colored scaled to the relative level of expertise within each subdomain. 
<hr>
